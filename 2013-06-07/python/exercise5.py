...
def complexRoad (l,w):
    road = GRID([[l],[w],[0.05]])
    lineaBottom = COLOR([2,2,2])(GRID([[l],[w/10],[-0.05,0.01]]))
    lineaTop = T([2])([w-w/10])(lineaBottom)
...
road1 = T([1,2,3])([0.1,3.6,0.01])(complexRoad(3.8,0.5))
road2 = T([1,2,3])([1.45,4,0.01])(simpleRoad(0.1,2))
road3 = T([1,2,3])([3,4,0.01])(simpleRoad(0.2,2))
road10 = T([1,2,3])([3,0.2,0.01])(simpleRoad(0.4,3.4))
roadSystem1 = STRUCT([road1,road2,road3,road10])

road4 = T([1,2,3])([8.7,2.5,0.01])(complexRoad(6.2,0.5))
road5 = T([1,2,3])([8.8,3,0.01])(simpleRoad(0.4,3))
road6 = T([1,2,3])([10.45,3,0.01])(simpleRoad(0.1,3))
road7 = T([1,2,3])([12,3,0.01])(simpleRoad(0.2,3))
road8 = T([1,2,3])([13.1,3,0.01])(simpleRoad(0.2,3))
road9 = T([1,2,3])([14.5,3,0.01])(simpleRoad(0.2,3))
roadSystem2 = STRUCT([road4,road5,road6,road7,road8,road9])

model5 = STRUCT([model4,roadSystem1,roadSystem2])
VIEW(model5)
