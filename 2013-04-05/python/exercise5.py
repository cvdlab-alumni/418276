...
'''
Exercise3. Define, with names north, south, east, and west, the 4 models of vertical enclosures (including the hollows), 
...
'''
Exercise5. Define with names stair1, stair2, and stair3 (from bottom up to top), and insert within the building model, 
